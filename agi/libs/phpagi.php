...
class AGI
{
    ...
    */
    function __construct($config=NULL, $optconfig=array())
    {
        ...
        // verbio TTS config
        if(!isset($this->config['verbio']['vt2f'])) $this->config['verbio']['vt2f'] = $this->which('vt2f');
    ...
    */
    ...
    /* CUSTOM DATETIME*/
    function say_datetime($time=NULL, $escape_digits='', $format=NULL, $timezone=NULL )
    {
        if(is_null($time)) $time = time();
        return $this->evaluate("SAY DATETIME $time \"$escape_digits\" \"$format\" \"timezone\" ");
    }
    ...
    */
	...
	//clear the buffer -FIX error: utils.c:1231 ast_carefulwrite: write() returned error: Broken pipe 
	// http://sourceforge.net/p/phpagi/discussion/366892/thread/5a4c09f0
